...
public class IncomingCallService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        params.windowAnimations =  R.anim.slide_in_from_right;
        ...
        Animation slideInAnimation = AnimationUtils.loadAnimation(getApplicationContext(), R.anim.slide_in_from_right);
        ...
        slideInAnimation.setAnimationListener(new Animation.AnimationListener() {
              ...
              public void onAnimationStart(Animation animation) {
                  // Animation started
                  Log.d("IncomingCallService", "Animation started");
              ...
              public void onAnimationEnd(Animation animation) {
                  // Animation ended
                  Log.d("IncomingCallService", "Animation ended");
              ...
              public void onAnimationRepeat(Animation animation) {
                  ...
                  Log.d("IncomingCallService", "Animation repeated");
