...
public class RnIncommingCallModule
    ...
    public void startListener() {
        ...
        // Sử dụng API mới cho Android >= 31
        callDetectionPhoneStateListener = new CallDetectionPhoneStateListener(this);
        telephonyManager.listen(callDetectionPhoneStateListener, TelephonyCallback.CallStateListener);
        } else {
            // Sử dụng API cũ cho Android < 31
            callDetectionPhoneStateListener = new CallDetectionPhoneStateListener(this);
