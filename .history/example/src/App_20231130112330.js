    ...
    () =>
      (data) => {
        if (data.state === 'extra_state_ringing') {
          ToastAndroid.showWithGravity('Ringing', ToastAndroid.LONG, ToastAndroid.BOTTOM)
          }
          else if (data.state ==='extra_state_offhook') {
            ToastAndroid.showWithGravity('Call Started', ToastAndroid.LONG, ToastAndroid.BOTTOM)
          }
          else if (data.state === 'extra_state_idle') {
            ToastAndroid.showWithGravity('Call Ended', ToastAndroid.LONG, ToastAndroid.BOTTOM)
          }
